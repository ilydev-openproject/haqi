...
class PesananPolicy
{
    ...
    {
        return $user->can('force_delete_pesanan');
    }
    ...
    {
        return $user->can('force_delete_any_pesanan');
    }
    ...
    {
        return $user->can('restore_pesanan');
    }
    ...
    {
        return $user->can('restore_any_pesanan');
    }
    ...
    {
        return $user->can('replicate_pesanan');
    }
    ...
    {
        return $user->can('reorder_pesanan');
    }
}
